...
// project c onto line segment ab
...
double DistancePointSegment(PT a, PT b, PT c) {
  return dis(c, ProjectPointSegment(a, b, c));
}
// signed distance!
...
// for segment, check if segments intersect first
